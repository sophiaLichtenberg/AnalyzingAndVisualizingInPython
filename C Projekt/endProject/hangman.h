...
void handleInputErrors(string input) {
  ...
  // if input is not a character or longer than just one letter, then the input is false and the user has to enter a letter again
...
// check whether a player has won or lost
